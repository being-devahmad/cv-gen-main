...
// import { X, Lightbulb, CheckCircle, ArrowLeft } from 'lucide-react';
...
//                         </motion.div>
//                         <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-200">Generating Ideas</h3>
//                         <p className="text-center text-gray-600 dark:text-gray-400">
//                             Crafting brilliant suggestions just for you...
//                         </p>
//                     </div>
//                 </DialogContent>
//             </Dialog>
